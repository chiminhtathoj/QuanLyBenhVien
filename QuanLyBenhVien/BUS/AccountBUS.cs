...
namespace BUS
{
    public class AccountBUS
    {
        ...
        public bool InsertAcc(string username, string type)
        {
            ...
            {
                string query = string.Format("insert into NGUOIDUNG ( TenDangNhap, Loai,MatKhau )VALUES ( N'{0}', N'{1}',N'{2}')", username, type, "2251022057731868917119086224872421513662");
        ...
        public string GetTypeAccByUserName(string username)
        {
            string query = string.Format("select Loai from NGUOIDUNG where TenDangNhap =N'{0}'", username);
